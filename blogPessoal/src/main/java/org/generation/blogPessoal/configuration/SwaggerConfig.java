...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			.title("Blog da Bryna")  
			.description("Projeto API Spring - Blog Pessoal-Generation Brasil") 
			.version("1.0.0")
	...
	private static Contact contact() {
		...
		return new Contact("Bruna de Freitas", "https://github.com/Brynafreitas", "brunadefreit4s@gmail.com");
